...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pages.add(new PageItem(R.drawable.he, "내 마음 속 작은 정원", "2022년에 생성됨","어느 날 아침, 나는 내 마음 속에 작은 정원이 있다는 사실을 깨달았다. 이 정원은 세상 누구에게도 보이지 않지만, 나만의 특별한 장소였다. 정원에는 내가 좋아하는 모든 것들이 있었다. 향기로운 꽃들, 부드럽게 흔들리는 나무들, 그리고 조용히 졸졸 흐르는 작은 시냇물까지. 이곳에서는 시간이 멈춘 것처럼 느껴졌다." +
